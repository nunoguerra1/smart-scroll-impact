...
import { Sparkles, ArrowRight, ShieldAlert, Lock, Mail, User, GitMerge } from "lucide-react";
...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen w-full bg-[#EBE6DF] text-[#1A1A1A] flex items-center justify-center p-6 relative overflow-hidden selection:bg-[#6A1A28] selection:text-[#EBE6DF]">
            ...
            <div className="absolute top-[-10%] right-[-10%] w-[40vw] h-[40vw] rounded-full bg-[#6A1A28]/5 blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-10%] left-[-10%] w-[40vw] h-[40vw] rounded-full bg-[#1A1A1A]/5 blur-[120px] pointer-events-none" />
            ...
            <main className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-12 items-center z-10 my-12">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#6A1A28]/30 bg-[#6A1A28]/5 backdrop-blur-md text-[#6A1A28] text-xs font-mono font-bold tracking-widest uppercase">
                        <Sparkles className="w-3.5 h-3.5" /> NOVO MEMBRO
                    </div>
                    ...
                    <p className="text-base sm:text-lg text-[#1A1A1A]/70 font-medium max-w-md leading-relaxed">
                        Junte-se à comunidade que trocou o doomscrolling por micro-aprendizados tangíveis. Crie sua conta em menos de 1 minuto.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-2">
                            <label className="text-xs font-mono font-bold tracking-widest uppercase text-[#1A1A1A]/70 flex items-center gap-2">
                                <User className="w-3.5 h-3.5 text-[#6A1A28]" /> Nome Completo
                            </label>
                            <input
                                type="text"
                                required
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-mono font-bold tracking-widest uppercase text-[#1A1A1A]/70 flex items-center gap-2">
                                <Mail className="w-3.5 h-3.5 text-[#6A1A28]" /> E-mail
                            </label>
                            <input
                                type="email"
                                required
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-mono font-bold tracking-widest uppercase text-[#1A1A1A]/70 flex items-center gap-2">
                                <Lock className="w-3.5 h-3.5 text-[#6A1A28]" /> Senha (mín. 6 caracteres)
                            </label>
                            <input
                                type="password"
                                required
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="group relative w-full py-5 bg-[#6A1A28] text-[#EBE6DF] overflow-hidden rounded-full font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-3 transition-transform duration-300 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 shadow-lg shadow-[#6A1A28]/20 mt-4"
                        >
